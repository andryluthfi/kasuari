...
class Relation extends CWidget {
    ...
    public function getRelatedData() {
        ...
        foreach ($parentobjects as $obj) {
            ...
            $defaultrules = array(
                '{fields}' => $fields,
                '{id}' => $obj[isset($this->relatedPk) ? 'ID' : $this->relatedPk]);
    ...
    public function renderBelongsToSelection() {
        if (strcasecmp($this->style, "dropDownList") == 0)
            echo CHtml::ActiveDropDownList(
                    $this->_model, $this->field, $this->getRelatedData(), $this->htmlOptions);
    ...
    protected function renderAddButton() {
        ...
        if (!$this->useLinkButton) {
            ...
            echo CHtml::LinkButton(
                    is_string($this->showAddButton) ? $this->showAddButton : 'New', array('submit' => $link));
        }
    }
