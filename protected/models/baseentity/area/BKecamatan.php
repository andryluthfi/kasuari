 ...
 */
class BKecamatan extends BaseModel {
    ...
    public function rules() {
        ...
        return array(
            array('kecamatan_number, kecamatan_name, kota_id', 'required'),
            ...
            array('kecamatan_id, kecamatan_number, kecamatan_name, kota_id', 'safe', 'on' => 'search'),
        );
    }
     ...
     * @return BKecamatan the static model class
     */
